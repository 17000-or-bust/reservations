...
PGPASSWORD=password /Library/PostgreSQL/11/bin/psql -U postgres -d reservations < psql.sql
...
echo "# ----- START PostgreSQL Output -----"
PGPASSWORD=password /Library/PostgreSQL/11/bin/psql -U postgres -d reservations < loadPsql.sql
echo "# ----- END PostgreSQL Output -----"
end=$(date +'%T')
