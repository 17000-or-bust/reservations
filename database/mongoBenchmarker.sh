...
runMongoTest()
{
  ...
  time mongo reservations --eval "$CMD"
}
...
# Reads
runMongoTest reservations "db.reservations.find({ id: 9999999 })"
runMongoTest restaurants "db.restaurants.find({ id: 9999999 })"
...
# Updates
runMongoTest reservations "db.reservations.update({ id: 10000000 }, { restaurant_id: 1908, date: '2019-04-24', time: '12:00' })"
runMongoTest restaurants "db.restaurants.update({ id: 10000000 }, { max_party_size: 2, max_days_to_book: 84, has_rewards: 1, time_slot_interval: '00:30:00', start_hour: '10:00', end_hour: '22:00', bookings_today: 40 })"

# Deletes
runMongoTest reservations "db.reservations.remove({ id: 10000000 })"
runMongoTest restaurants "db.restaurants.remove({ id: 10000000 })"
